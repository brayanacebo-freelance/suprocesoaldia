$(function(){
    ...
    $(window).load(function () {
        setTimeout(function () {
            ...
            {
                $('#style-base').attr('href', '/admin/css/stilearn.css');
                $('#style-responsive').attr('href', '/admin/css/stilearn-responsive.css');
                $('#style-helper').attr('href', '/admin/css/stilearn-helper.css');
                $('#style-calendar').attr('href', '/admin/css/fullcalendar.css');
            }else{
                themes = sessionStorage.themes;
                theme_mode = sessionStorage.theme_mode;

                $('#style-base').attr('href', '/admin/css/themes/'+themes+'/stilearn.css');
                $('#style-responsive').attr('href', '/admin/css/themes/'+themes+'/stilearn-responsive.css');
                $('#style-helper').attr('href', '/admin/css/themes/'+themes+'/stilearn-helper.css');
                $('#style-calendar').attr('href', '/admin/css/themes/'+themes+'/fullcalendar.css');
    ...
    $('.themes-changer').click(function(e){
        ...
        if(data_themes == ''){
            ...
            $('#style-base').attr('href', '/admin/css/themes/'+data_themes+'/stilearn.css');
            $('#style-responsive').attr('href', '/admin/css/themes/'+data_themes+'/stilearn-responsive.css');
            $('#style-helper').attr('href', '/admin/css/themes/'+data_themes+'/stilearn-helper.css');
            $('#style-calendar').attr('href', '/admin/css/themes/'+data_themes+'/fullcalendar.css');
        }
