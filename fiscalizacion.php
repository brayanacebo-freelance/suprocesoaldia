...
<title> Servicios :: suprocesoaldia.com </title>
    ...
    <div id="content">
        ...
        <div class="row">
        	<div class="span12">
                ...
                <h3 class="headline">
                	<span>Fiscalización de procesos judiciales</span>
                </h3>
        	...
        	<div class="span4">
                ...
                <div class="icon-box-1">
                    ...
                    <div class="icon-box-content">
                        ...
                        <h3>
                            <a href="#">NOTIFICACIONES VIA E-MAIL</a>
                        </h3>
                        
                        <p>Reciba un correo electrónico con el detalle de la actuación y el día en que el movimiento procesal sucede.</p>
            ...
            <div class="span4">
                ...
                <div class="icon-box-1">
                    ...
                    <div class="icon-box-content">
                        ...
                        <h3>
                            <a href="#">HOJA DE VIDA PROCESAL</a>
                        </h3>
                        
                        <p>Consulte desde su smartphone, tablet o pc y en cualquier momento sus procesos y el historial de movimientos de cada uno.</p>
            ...
            <div class="span4">
                ...
                <div class="icon-box-1">
                    ...
                    <div class="icon-box-content">
                        ...
                        <h3>
                            <a href="#">FOTOS DE ACTUACIONES</a>
                        </h3>
                        
                        <p>Acceda en cualquier momento a todas las fotos de la actuación procesal sin necesidad de desplazarse al despacho judicial</p>
        ...
        <div class="box" style="background-color: #00a0b1; margin-bottom: 0px;">
                    ...
                    <div class="callout-box hidden-phone">
                        ...
                        <div class="row">
                            <div class="span9">
                                ...
                                <div class="icon-box-1">
                                    ...
                                    <div class="icon-box-content">
                                        ...
                                        <h2>
                                            <a href="contacto.html">Esta interesado en <strong>ADQUIRIR NUESTROS SERVICIOS</strong></a>
                                        </h2>
                                        
                                        <p class="last hidden-tablet">Envíenos sus datos y consultor jurídico se comunicará con usted y le brindará toda la información necesaria.</p>
                            ...
                            <div class="span3 text-right">
                                ...
                                <a class="btn btn-large btn-black" href="contactenos.html"><strong>Contáctenos</strong> Ahora</a>
