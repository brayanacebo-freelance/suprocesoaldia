...
<div class="span11">
  ...
  <div class="content">
      ...
      <ul class="content-header-action pull-right">
        ...
        <li>
          <a href="#">
            ...
            <div class="action-text color-teal">{{count($types)}} <span class="helper-font-small color-silver-dark">Notificaciones</span></div>
          </a>
        </li>
      </ul>
    ...
    <div class="content-body">
      ...
      <div class="span3">
        <p>
          <a href="{{ route('notification-types.create') }}" class="btn btn-block btn-primary">Nueva notificación</a>
        </p>
      </div>
      <!-- tables -->
      <!--datatables-->
                ...
                <tbody>
                  ...
                  @foreach($types as $type)
                    <tr>
                      <th>{{ $type->id }}</th>
                      <th>{{ $type->name }}</th>
                    <td class="center"><a href="{{ route('notification-types.edit', $type->id) }}" class="btn btn-success btn-small">Editar <i class="icofont-angle-right"></i></a></td>
                    </tr>
                  @endforeach
                </tbody>
              </table>
