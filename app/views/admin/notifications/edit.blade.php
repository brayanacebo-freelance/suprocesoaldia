...
<div class="span11">
  ...
  <div class="content">
      ...
      <ul class="content-header-action pull-right">
        ...
        <li>
          <a href="#">
            ...
            <div class="action-text color-teal">10 <span class="helper-font-small color-silver-dark">Notificaciones</span></div>
          </a>
        </li>
        <li class="divider"></li>
        <li>
          <a href="#">
            ...
            <div class="action-text color-green">{{$type->id}}} <span class="helper-font-small color-silver-dark">Cód. Notificación</span></div>
          </a>
        </li>
      </ul>
      <h2><i class="icofont-table"></i> Notificaciones</h2>
    </div><!-- /content-header -->
    ...
    <div class="content-breadcrumb">
      <!--breadcrumb-->
      <ul class="breadcrumb">
        <li><a href="#"><i class="icofont-circle-arrow-right"></i> Notificaciones</a> <span class="divider">&rsaquo;</span></li>
  ...
  <div class="span12">
    ...
    <div class="box corner-all">
      ...
      <div class="box-body">
        <!--validation-->
        <div class="row-fluid">
          <form class="form-horizont" id="form-validate" action="{{ route('notification-types.update', $type->id) }}" method="POST">
          <input type="hidden" name="_method" value="PUT">
            <fieldset>
              ...
              <div class="control-group">
                ...
                <div class="controls">
                  <input type="text" class="grd-white" data-validate="{required: true, messages:{required:'Please enter field required'}}" name="name" id="required" value="{{ $type->name }}" />
                </div>
              </div>
