                                        ...
                                        <div class="span12">
                                            ...
                                            <div class="box corner-all">
                                                ...
                                                <div class="box-body">
                                                    <!--validation-->
                                                    <div class="row-fluid">
                                                        <form class="form-horizont" id="form-validate" action="{{ route('departments.update', $department->id) }}" method="POST">
                                                        <input type="hidden" name="_method" value="PUT">
                                                            <fieldset>
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" class="grd-white" data-validate="{required: true, messages:{required:'Please enter field required'}}" name="name" id="required" value="{{$department->name }}" />
                                                                    </div>
                                                                </div> 
