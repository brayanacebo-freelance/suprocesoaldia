...
<div class="span11">
  ...
  <div class="content">
      ...
      <ul class="content-header-action pull-right">
        ...
        <li>
          <a href="#">
            ...
            <div class="action-text color-teal">{{ $actions_count }} <span class="helper-font-small color-silver-dark">Actuaciones</span></div>
          </a>
        </li>
        <li class="divider"></li>
        <li>
          <a href="#">
            ...
            <div class="action-text color-green">{{$action->id}} <span class="helper-font-small color-silver-dark">Cód. Actuación</span></div>
          </a>
        </li>
      </ul>
    ...
    <div class="content-breadcrumb">
      <!--breadcrumb-->
      <ul class="breadcrumb">
        <li><a href="{{ route('actions.index') }}"><i class="icofont-circle-arrow-right"></i> Actuaciones</a> <span class="divider">&rsaquo;</span></li>
        <li class="active">Editar actuación</li>
      </ul><!--/breadcrumb-->
      ...
      <div class="span12">
        ...
        <div class="box corner-all">
          ...
          <div class="box-header grd-teal color-white corner-top">
            ...
            <span>Editar actuación </span>
          </div><!--/box header-->
          <!--box body-->
          <div class="box-body">
            <!--validation-->
            <div class="row-fluid">
              <form class="form-horizont" id="form-validate" action="{{ route('actions.update', $action->id) }}" method="POST">
              <input type="hidden" name="_method" value="PUT">
                <fieldset>
                  ...
                  <div class="control-group">
                    ...
                    <div class="controls">
                      <input type="text" class="grd-white" data-validate="{required: true, messages:{required:'Please enter field required'}}" name="name" id="required" value="{{$action->name}}" />
                    </div>
                  </div>
