...
Route::group(array('before' => 'auth'), function ()
{
	...
	Route::get('clients/{id}/parchive' , array('uses' => 'ClientsController@pArchive', 'as' =>'clients.parchive'));
	Route::get('clients/{id}/pnoarchive' , array('uses' => 'ClientsController@pNoArchive', 'as' =>'clients.pnoarchive'));
});
