...
<div class="span11">
  ...
  <div class="content">
    ...
    <div class="content-breadcrumb">
      <!--breadcrumb-->
      <ul class="breadcrumb">
        <li><a href="{{route('notification-types.index')}}"><i class="icofont-circle-arrow-right"></i> Notificaciones</a> <span class="divider">&rsaquo;</span></li>
      ...
      <div class="span12">
        ...
        <div class="box corner-all">
          ...
          <div class="box-body">
            <!--validation-->
            <div class="row-fluid">
              {{ Form::open(array('route' => 'notification-types.store')) }}
              <fieldset>
                ...
                <div class="form-actions">
                  <button type="submit" class="btn btn-primary">Crear notificación
                  </button>
                </div>
              </fieldset>
            </form><!--/validation-->
