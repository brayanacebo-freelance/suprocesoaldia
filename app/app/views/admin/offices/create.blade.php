  ...
  <div class="span12">
    ...
    <div class="box corner-all">
      ...
      <div class="box-body">
        <!--validation-->
        <div class="row-fluid">
          {{ Form::open(array('route' => array('departments.cities.offices.store', $department_id, $city->id),'id'=>'form-validate')) }}
            <fieldset>
              ...
              <div class="form-actions">
                <button type="submit" class="btn btn-primary">Crear despacho
                </button>
              </div>
            </fieldset>
          </form><!--/validation-->
