            ...
            <div class="content">
                            ...
                            <ul class="content-header-action pull-right">
                                ...
                                <li>
                                    <a href="#">
                                        ...
                                        <div class="action-text color-teal">{{ $client->processes->count() }} <span class="helper-font-small color-silver-dark">Clientes</span></div>
                                    </a>
                                </li>
                            </ul>
                        ...
                        <div class="content-breadcrumb">
                            ...
                            <ul class="breadcrumb">
                                ...
                                <li><a href="{{ route('clients.show', $client->id) }}"><i class="icofont-circle-arrow-right"></i> Información del cliente</a> <span class="divider">&rsaquo;</span></li>
                                        ...
                                        <div class="span12">
                                            ...
                                            <div class="box corner-all">
                                                ...
                                                <div class="box-body">
                                                    <!--validation-->
                                                    <div class="row-fluid">
                                                        <form class="form-horizont" id="form-validate" action="{{route('clients.update' ,  array($client->id))}}" method="POST">
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" class="grd-white" data-validate="{required: true, messages:{required:'Please enter field required'}}" name="enterprise" id="required" value="{{$client->enterprise}}" />
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                                                    <label class="control-label" for="minlength">Responsable</label>
                                                                    <div class="controls">
                                                                        <input type="text" class="grd-white" data-validate="{required: true, minlength: 2, messages:{required:'Please enter field min length', minlength:'Please enter at least 2 characters.'}}" name="in_charge" id="minlength" value="{{$client->in_charge}}" />
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
                                        ...
                                        <div class="span12">
                                            ...
                                            <div class="box corner-all">
                                                ...
                                                <div class="box-body">
                                                    <!--validation-->
                                                    <div class="row-fluid">
                                                        <form class="form-horizont" id="form-validate2" action="{{route('clients.user.edit' , array($client->id))}}" method="POST">
                                                            ...
                                                            <fieldset>
                                                                ...
                                                                <div class="control-group">
                                                                    ...
                                                                    <div class="controls">
                                                                        <input type="text" class="grd-white" data-validate="{required: true, email:true, messages:{required:'Please enter field email', email:'Please enter a valid email address'}}" name="email" id="email" value="{{$client->user->email}}" />
                                                                    </div>
                                                                </div>
                                                                <div class="control-group">
