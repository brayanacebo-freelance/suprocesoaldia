  ...
  <div class="content">
      ...
      <ul class="content-header-action pull-right">
        ...
        <li>
          <a href="#">
            ...
            <div class="action-text color-green">{{$type->id}} <span class="helper-font-small color-silver-dark">Cód. Tipo de proceso</span></div>
          </a>
        </li>
      </ul>
    ...
    <div class="content-breadcrumb">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">Editar tipo de proceso</li>
      </ul><!--/breadcrumb-->
        ...
        <div class="span12">
          ...
          <div class="box corner-all">
            ...
            <div class="box-body">
              <!--validation-->
              <div class="row-fluid">
                <form class="form-horizont" id="form-validate" action="{{ route('process-types.update', $type->id) }}" method="POST">
