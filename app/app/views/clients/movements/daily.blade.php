  ...
  <div class="content">
    ...
    <div class="content-breadcrumb">
      ...
      <ul class="breadcrumb">
        ...
        <li class="active">Movimientos diarios</li>
      </ul><!--/breadcrumb-->
    ...
    <div class="content-body">
      <div class="row-fluid">
        <div class="span8"><h3>Movimientos diarios</h3></div>        
      </div>
      <div class="row-fluid">
        <div class="span12">
            ...
            <div class="box-body">
              <table id="datatables" class="table table-bordered table-striped responsive">
                ...
                <tbody>
                  ...
                  <?php 
                    $_date = new DateTime($movement->process->updated_at); 
                    $dateTwo = $_date->format('Y-m-d'); 
                  ?>
                    @if( $dateTwo === $date )
                      <tr>
                        <td>{{ $movement->id }}</td>
