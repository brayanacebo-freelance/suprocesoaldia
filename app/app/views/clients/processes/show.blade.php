      ...
      <ul class="content-header-action pull-right">
        ...
        <div class="content-breadcrumb">
          ...
          <ul class="breadcrumb">
            ...
            <li><a href="{{ route('clients.index') }}"><i class="icofont-circle-arrow-right"></i> Información del ciente</a> <span class="divider">&rsaquo;</span></li>
                                  ...
                                  <table class="table table-bordered table-striped invoice responsive">
                                    <tbody>
                                      ...
                                      <tr>
                                        ...
                                        <td>{{ $movement->notification_date }}</td>
                                      </tr>
                                      <tr>
                                        <td><span class="color-teal">Fecha auto</span></td>
                                        <td>{{ $movement->auto_date }}</td>
                                      </tr>
                                      <tr>
