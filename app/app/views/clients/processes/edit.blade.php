  ...
  <div class="content">
    ...
    <div class="content-breadcrumb">
      ...
      <ul class="breadcrumb">
        ...
        <li><a href="{{ route('clients.index') }}"><i class="icofont-circle-arrow-right"></i> Información del cliente</a> <span class="divider">&rsaquo;</span></li>
            ...
            <fieldset>
              ...
              <div class="span6">
                ...
                <div class="control-group">
                  ...
                  <div class="controls">
                    <input type="text" class="grd-white" data-validate="{required: true, messages:{required:'Campo obligatorio'}}" name="claimant" id="required" value="{{$process->claimant}}" />
                  </div>
                </div>
                <div class="control-group">
                  <label class="control-label" for="required">Demandando</label>
                  <div class="controls">
                    <input type="text" class="grd-white" data-validate="{required: true, messages:{required:'Campo obligatorio'}}" name="defendant" id="required" value="{{$process->defendant}}" />
                  </div>
                </div>
              </div>
            </div>
